...
namespace MyGame
{
    ...
    class HighScoreController
    {
        ...
        private static void LoadScores()
        {
            ...
            int numScores = 0;
            numScores = System.Convert.ToInt32(input.ReadLine());
            ...
            for (i = 1; i <= numScores; i++)
            {
                ...
                s.Value = System.Convert.ToInt32(line.Substring(NAME_WIDTH));
                _Scores.Add(s);
            }
            input.Close();
        }
        ...
        public static void DrawHighScores()
        {
            ...
            for (i = 0; i <= _Scores.Count - 1; i++)
            {
                ...
                {
                    SwinGame.DrawText(
                        " " + System.Convert.ToString(i + 1) + ":   " + s.Name + "   " + System.Convert.ToString(s.Value), Color.White, GameResources.GameFont("Courier"), SCORES_LEFT, SCORES_TOP + i * SCORE_GAP);
                }
                else
                {
