...
namespace MyGame
{
    ...
    public class BattleShipsGame
    {
        ...
        /// </remarks>
        private AttackCompletedHandler AttackCompletedEvent;
        public event AttackCompletedHandler AttackCompleted
        {
            add
            {
                AttackCompletedEvent = (AttackCompletedHandler)System.Delegate.Combine(AttackCompletedEvent, value);
            }
            remove
            {
                AttackCompletedEvent = (AttackCompletedHandler)System.Delegate.Remove(AttackCompletedEvent, value);
            }
        }
